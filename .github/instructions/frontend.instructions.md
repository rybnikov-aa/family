...
## Макеты и итерации UI

- При существенной переработке макета (детализация VPS, формы, карточки) предлагай 2–3 варианта
  на выбор вместо одной реализации — это сокращает цикл правок «переделай/верни как было».
- Точное позиционирование элементов (отступы, выравнивание, порядок кнопок/иконок) формулируй
  конкретно и проверяй результат в браузере; при неоднозначности уточняй у пользователя до правки.
