...
- **Шапка «Блока 1. Работы»:** вместо строк «Смета (план)»/«Выполнено по актам» и бейджа
...
- **Бюджет на материалы («Блок 2. Материалы»):** прогресс-бар как у «Блока 1. Работы» —
...
- **Строки документов в сводке** (акты в «Блоке 1. Работы», заказы в «Блоке 2. Материалы») —
  ...
  заголовка, как pill даты ведомости. Заголовки «Взаиморасчёты (работы)/(материалы)» —
