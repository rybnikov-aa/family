...
| GET   | `/api/immich/assets/:id/original`  | Оригинал ассета (импорт в событие) — стрим      | `id` — UUID ассета; ответ — файл (прокси потоком); 400 — некорректный id, 404 — не найден, 502 — ошибка апстрима                                                                                                                                                                                                 |
