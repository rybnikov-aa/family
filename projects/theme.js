...
(function () {
  ...
  // Иконки как в переключателе приложения (SVG, stroke=currentColor).
  var ICONS = {
    sun: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>',
    moon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>',
    monitor:
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="3" rx="2" ry="2"/><line x1="8" x2="16" y1="21" y2="21"/><line x1="12" x2="12" y1="17" y2="21"/></svg>',
  };
  ...
  function mount(mode) {
    ...
    var options = [
      { mode: 'light', label: 'светлая', icon: ICONS.sun },
      { mode: 'dark', label: 'тёмная', icon: ICONS.moon },
      { mode: 'system', label: 'система', icon: ICONS.monitor },
    ];
    ...
    options.forEach(function (opt) {
      ...
      icon.className = 'theme-toggle__icon theme-toggle__icon--' + opt.mode;
