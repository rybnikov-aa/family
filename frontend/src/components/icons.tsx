...
/** Фотография со стрелкой загрузки (Lucide ImageUp). */
...
/** Фотография с плюсом (Lucide ImagePlus). */
...
/** Несколько фотографий — галерея (Lucide Images). */
