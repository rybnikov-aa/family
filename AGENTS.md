...
Подробно: [README.md](README.md) (структура, .env, деплой) · [docs/specification.md](docs/specification.md) (общая спецификация + модульные `specification-{api,vps,projects,auth,renovation,diary}.md`) · [docs/adr.md](docs/adr.md) (решения и обоснования ADR-1…ADR-25) · [docs/immich.md](docs/immich.md) (интеграция с Immich: API, варианты, шаг 1 — админ-настройки) · [docs/backup.md](docs/backup.md) (бэкап и восстановление) · [docs/server.md](docs/server.md) (nginx, SSL, сервер, диагностика).
