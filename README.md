...
├── .github/skills/           # скиллы для ИИ-агентов (загружаются по запросу)
...
Помимо `docs/`, в корне есть `AGENTS.md` — инструкции для ИИ-агентов (команды, правила, типичные грабли), а специализированные рабочие процессы вынесены в скиллы `.github/skills/` (например, `vps` — VPS-мониторинг со справочником и скриптом просмотра БД).
